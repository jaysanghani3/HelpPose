    ...
    <div className="modal-dialog  m-0 ms-auto modalArea modal-xl modal-dialog-scrollable">
      <div tabIndex={-1} className="modal-content rounded-0" style={{height:'100vh'}}>
        <div className="modal-header align-items-center">
            <button type="button" className="offCanvaBtn py-2 px-3" data-bs-dismiss="modal">
              <i className="bi bi-arrow-left me-2" /> Back
            </button>
            <div className="ms-auto">
              <button className="offCanvaBtn me-3 py-2 px-3">
        ...
        <div className="modal-body px-4">
          <div>
            ...
            <div className="Information border rounded p-2 my-3">
              <h4>Information</h4>
              <div className="smallText">Difficulty : <span>{question.difficulty}</span></div>
              <div className="smallText">Duration : <span>{question.timeLimit} min</span></div>
              <div className="smallText">Author : <a href="#">link...</a></div>
            </div>
              </div>
            </div>
          </div>
